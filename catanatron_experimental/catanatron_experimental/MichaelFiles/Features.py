...
def calculate_resource_production_for_number(board, number, r_p = 0.9):
...
def calculate_resource_production_value_for_player(state, p0_color, robber_penalty=0.9):
    ...
    for number, prob in prob_dict.items():
        payout = calculate_resource_production_for_number(state.board, number, r_p=robber_penalty)
